---
title: "Custom software or SaaS: how to decide"
...
faq:
  ...
  - question: "When is SaaS the right choice?"
    answer: "When the need is narrow, the team is small and speed matters most. An invoicing tool, a CRM for three salespeople, a shared schedule: at 30 or 50 euros a month, a subscription does the job perfectly. Commissioning custom development for something that already exists as a subscription is the most common way to waste a digital budget."
  - question: "What signals that it is time to go custom?"
    answer: "The day you spend more time working around your tool's limits than using it. In practice: daily Excel exports to compensate for a missing report, double data entry between two systems, or a process explained to every new hire as we do it this way because the software cannot do otherwise. Those workarounds carry a payroll cost almost nobody quantifies."
  - question: "Is no-code a credible alternative?"
    answer: "Often, yes. No-code or low-code development is three to four times faster than classic development, at a cost 30 to 50% lower. For many SMEs needing a specific business tool without extreme technical complexity, it is currently the most balanced compromise between a standard subscription and full custom development."
  - question: "What risks come with custom software?"
    answer: "Three mainly. Vendor lock-in, if the code and access credentials are not contractually yours. Scope creep, when every meeting adds a feature. And unbudgeted maintenance, which turns a good tool into technical debt within two years. All three are handled in the contract, not afterwards."
---
...
For an SME with **20 users at 150 dollars per licence per month**, the subscription comes to **180,000 dollars over five years**. Custom development costs **40,000 to 80,000 dollars upfront**, plus **5,000 to 10,000 dollars of annual maintenance**, so **65,000 to 130,000 dollars over the same period** ([CyberPerformance](https://cyberperformance.ca/logiciel-sur-mesure-ou-saas-quel-choix-pour-une-pme/)).
...
It is one of the signals we detail in our article on [the signs it is time to go digital](/en/blog/digital-transformation-small-business/).
...
Torn between subscribing and building? [Let's talk about your project](/en/#contact): we will look at your processes and tell you frankly which side you are on.
